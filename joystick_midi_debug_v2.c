...
/* joystick_midi_debug_v2.c
 *
 * Combina la lógica mejorada de interpretación con envío de mensajes MIDI.
 * - Joysticks: 4 direcciones básicas (arriba, abajo, izquierda, derecha)
 * - Gatillos: Interpretados como botones únicos
 * - Otros botones se mantienen y se asignan a notas MIDI
 */
...
int main() {
    ...
    printf("Joystick MIDI Debug V2 iniciado. Presiona Ctrl+C para salir.\n");
